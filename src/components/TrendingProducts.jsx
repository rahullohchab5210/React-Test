                                ...
                                return <div key={i} className='w-full  md:w-[50%] lg:w-[33.33%] px-3'>
                                    <div className='p-[16px] bg-white border border-[#0000000D] hover:shadow-2xl transition-shadow  '>
                                        <div className='relative group'>
                                            <span className='absolute top-[20px] right-[20px] z-1 cursor-pointer w-[35px] h-[35px] flex items-center justify-center bg-[#FFFFFFA8] rounded-[58.33%]'><svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
