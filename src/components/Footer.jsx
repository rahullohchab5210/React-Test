                ...
                <div className='flex flex-row justify-between max-md:flex-col max-md:gap-y-[30px]'>
                    <div className='max-w-[326px] text-white'>
                        ...
                        <div className='flex flex-row gap-[14px] mt-[20px]'>
                            <a href="https://www.youtube.com/" target='blank' className='w-[32px] h-[32px] flex items-center justify-center border border-[#FFFBF2] rounded-[100px]'><svg width="15" height="10" viewBox="0 0 15 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="https://www.facebook.com/" target='blank' className='w-[32px] h-[32px] flex items-center justify-center border border-[#FFFBF2] rounded-[100px]'><svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href=" https://x.com/" target='blank' className='w-[32px] h-[32px] flex items-center justify-center border border-[#FFFBF2] rounded-[100px]'><svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="https://www.linkedin.com/" target='blank' className='w-[32px] h-[32px] flex items-center justify-center border border-[#FFFBF2] rounded-[100px]'><svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
